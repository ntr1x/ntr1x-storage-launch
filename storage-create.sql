...
CREATE TABLE publications (ResourceId BIGINT NOT NULL, Body LONGTEXT, Promo LONGTEXT, Published DATETIME, Subtitle VARCHAR(255) NOT NULL, Title VARCHAR(255) NOT NULL, ImageId BIGINT, RelateId BIGINT, UserId BIGINT NOT NULL, PRIMARY KEY (ResourceId))
...
CREATE TABLE offers (ResourceId BIGINT NOT NULL, Body LONGTEXT, Promo LONGTEXT, Title VARCHAR(255) NOT NULL, ImageId BIGINT, RelateId BIGINT, UserId BIGINT NOT NULL, PRIMARY KEY (ResourceId))
