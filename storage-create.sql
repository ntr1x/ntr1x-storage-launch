CREATE TABLE resources (Id BIGINT AUTO_INCREMENT NOT NULL, DTYPE VARCHAR(31), Alias VARCHAR(255), Extra VARCHAR(255), Scope BIGINT NOT NULL, PRIMARY KEY (Id))
...
CREATE TABLE publications (ResourceId BIGINT NOT NULL, Body LONGTEXT, Promo LONGTEXT, Published DATETIME, Subtitle VARCHAR(255), Title VARCHAR(255) NOT NULL, ImageId BIGINT, RelateId BIGINT, UserId BIGINT, PRIMARY KEY (ResourceId))
...
CREATE TABLE offers (ResourceId BIGINT NOT NULL, Body LONGTEXT, Promo LONGTEXT, Title VARCHAR(255) NOT NULL, ImageId BIGINT, RelateId BIGINT, UserId BIGINT, PRIMARY KEY (ResourceId))
CREATE TABLE orders (ResourceId BIGINT NOT NULL, Created DATETIME, Quantity DECIMAL(10,2), State INTEGER NOT NULL, RelateId BIGINT NOT NULL, UserId BIGINT NOT NULL, PRIMARY KEY (ResourceId))
...
ALTER TABLE publications ADD CONSTRAINT FK_publications_ImageId FOREIGN KEY (ImageId) REFERENCES resources (Id)
...
ALTER TABLE offers ADD CONSTRAINT FK_offers_ImageId FOREIGN KEY (ImageId) REFERENCES resources (Id)
ALTER TABLE offers ADD CONSTRAINT FK_offers_ResourceId FOREIGN KEY (ResourceId) REFERENCES resources (Id) ON DELETE CASCADE
ALTER TABLE offers ADD CONSTRAINT FK_offers_RelateId FOREIGN KEY (RelateId) REFERENCES resources (Id)
ALTER TABLE offers ADD CONSTRAINT FK_offers_UserId FOREIGN KEY (UserId) REFERENCES resources (Id)
ALTER TABLE orders ADD CONSTRAINT FK_orders_UserId FOREIGN KEY (UserId) REFERENCES resources (Id)
ALTER TABLE orders ADD CONSTRAINT FK_orders_ResourceId FOREIGN KEY (ResourceId) REFERENCES resources (Id) ON DELETE CASCADE
ALTER TABLE orders ADD CONSTRAINT FK_orders_RelateId FOREIGN KEY (RelateId) REFERENCES resources (Id)
